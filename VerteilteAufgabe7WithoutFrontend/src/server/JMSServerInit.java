...
public class JMSServerInit {
	...
	public JMSServerInit() throws NamingException, JMSException {
		...
		sender = session.createSender(queue2);
	...
	public void receiveMessage() throws JMSException {
		...
		while (true) {
			...
			//Abfrage ob Client abfragen will (TextMessage)
				...
				TextMessage messageAnswer = session.createTextMessage();
				messageAnswer.setText(server.umfrageWerte().toString());
				sender.setTimeToLive(0);
				sender.send(messageAnswer);
